//#region src/lib/exerciseSearch.js
...
function scoreExerciseMatch(query, exercise) {
	...
	const fuzzyScore = tokens.reduce((sum, token) => sum + getBestTokenMatchScore(token, nameTokens), 0);
	if (fuzzyScore > 0) return 24 + Math.round(fuzzyScore * 12);
	return 10;
}
//#endregion
export { normalizeSearchValue as n, scoreExerciseMatch as r, matchesSearchQuery as t };

//# sourceMappingURL=exerciseSearch-yksvqij-.js.map